namespace ProjeOdev
{
    partial class Form4
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.TabIndex = 0;
            label1.Text = "Ceza Bilgisi Öğrenmek İçin Plaka Numarası Giriniz.";
            // 
            // textBox1
            // 
            ...
            OdemeYapButton.Text = "ÖDEME YAP";
            OdemeYapButton.UseVisualStyleBackColor = false;
            ...
            label4.TabIndex = 80;
            label4.Text = "Son Kullanım Tarihi : ";
            ...
            // Ode
            // 
            Ode.BackColor = Color.FromArgb(192, 192, 255);
            Ode.Font = new Font("Segoe UI", 16F, FontStyle.Regular, GraphicsUnit.Point);
            Ode.Location = new Point(681, 642);
            Ode.Name = "Ode";
            Ode.Size = new Size(94, 47);
            Ode.TabIndex = 87;
            Ode.Text = "ÖDE";
            ...
            CezaBilgisiOgrenSayfasinaDon.Text = "CEZA BİLGİSİ ÖĞREN  SAYFASINA DÖN";
