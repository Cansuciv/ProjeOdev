namespace ProjeOdev
{
    partial class Form3
    {
        ...
        private void InitializeComponent()
        {
            ...
            Plaka = new Label();
            CezaTuru = new Label();
            CezaMiktarı = new Label();
            CezaGirişTarihi = new Label();
            CezaSonÖdemeTarihi = new Label();
            ...
            YetkiliPolisSayfasinaDon = new Button();
            SuspendLayout();
            // 
            // CezaBilgisiOgren
            // 
            ...
            CezaEkle.UseVisualStyleBackColor = false;
            ...
            CezaGirişTarihi.Text = "Ceza Giriş Tarihi :";
            ...
            CezaSonÖdemeTarihi.Text = "Ceza Son Ödeme Tarihi :";
            ...
            YetkiliPolisSayfasinaDon.Text = "YETKİLİ POLİS SAYFASINA DÖN";
            YetkiliPolisSayfasinaDon.UseVisualStyleBackColor = false;
            YetkiliPolisSayfasinaDon.Click += YetkiliPolisSayfasinaDon_Click;
            // 
            // Form3
            // 
            ...
            Controls.Add(CezaSonÖdemeTarihi);
            Controls.Add(CezaGirişTarihi);
            Controls.Add(CezaMiktarı);
            Controls.Add(CezaTuru);
            Controls.Add(Plaka);
            Controls.Add(Ilce);
            Controls.Add(Sehir);
        ...
        private Label Ilce;
        private Label Plaka;
        private Label CezaTuru;
        private Label CezaMiktarı;
        private Label CezaGirişTarihi;
        private Label CezaSonÖdemeTarihi;
        ...
        private Button YetkiliPolisSayfasinaDon;
    }
}